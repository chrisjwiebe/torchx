...
you may have to pass additional scheduler cfgs with the ``-cfg`` option. See the
`remote scheduler section<https://pytorch.org/torchx/latest/quickstart.html#Remote-Schedulers>`_
 on the quickstart guide for more details.
